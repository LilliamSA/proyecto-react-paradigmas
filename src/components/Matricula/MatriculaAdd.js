...
const MatriculaAdd = () => {
  ...
  const handleSelectChange = (selectedOptionPeriodo) => {
    setSelectedOptionPeriodo(selectedOptionPeriodo); //actualiza el estado
    setIdPeriodo(selectedOptionPeriodo.value); //actualiza el idPeriodo

    //busca las materias por el id del periodo seleccionado
  ...
  //metodo validar cupos de la materia seleccionada
  const validarCupos = () => {
  ...
  return (
    <div className="container mt-5">
      <h1 className="text-center mb-4">
        Formulario para agregar una matricula
      </h1>
          ...
          <div className="col-md-6 text-center">
            ...
            {err && (
              <div className="alert alert-danger text-center" role="alert">
                Error, no se puede matricular un curso que no tiene cupos
                disponibles o ya se encuentra matriculado en la materia
                seleccionada
              </div>
            )}
            {input && (
